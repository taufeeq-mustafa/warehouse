    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-content">
        ...
        <section className="info-section">
          <div className="info-card" onClick={() => handleNavigation('/finance')}>
            <span className="icon">💰</span>
            <h3>Finance Hub</h3>
            <p>$250,000</p>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/orders')}>
            <span className="icon">📈</span>
            <h3>Manage Orders</h3>
            <p>24 Pending</p>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/suppliers')}>
            <span className="icon">👤</span>
            <h3>Supplier Management</h3>
            <p>12 Active</p>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/products')}>
            <span className="icon">📦</span>
            <h3>Manage Products</h3>
            <p>156 Items</p>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/add-product')}>
            <span className="icon">➕</span>
            <h3>Add New Product</h3>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/track-product')}>
            <span className="icon">📍</span>
            <h3>Track Product</h3>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/product-details')}>
            <span className="icon">📄</span>
            <h3>Report</h3>
          </div>
          <div className="info-card" onClick={() => handleNavigation('/generate-barcode')}>
            <span className="icon">🔖</span>
            <h3>Print Barcode</h3>
          </div>
